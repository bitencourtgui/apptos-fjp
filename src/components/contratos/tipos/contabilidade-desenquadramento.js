...
export const ContabilidadeDesenquadramento = ({ contract }) => {
  ...
  const calculatePaymentDate = (created, paymentDate) => {
        ...
        <View style={styles.paymentContainer} wrap={false}>
          {services.map((service, key) => {
            if (service.type === "0") {
              ...
              return (
                <View style={styles.paymentContainer} wrap={false} key={key}>
