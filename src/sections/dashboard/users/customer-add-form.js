...
export const CustomerAddForm = (props) => {
  ...
  const handleAddress = async (e, formik) => {
    ...
    formik.setFieldValue("postalCode", numericValue);

    try {
      const response = await CustomersApi.getCustomerAdress(numericValue);

      formik.setFieldValue("street", response.street);
